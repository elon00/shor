...
const criteria = [report.source, report.realRpcVerifier, report.pqcGate, report.deploymentEvidence];
report.status = criteria.every(Boolean) ? 'RELEASE_CANDIDATE' : 'BLOCKED';
